...
// ── Geo distance (haversine, meters) — used to confirm a punch happened
// within the shop's registered location radius. Returns Infinity if either
// point is missing so callers can treat "no location set" as "don't block".
