...
-- Login: username 'admin' / password 'cojwTkD71FRf' — CHANGE THIS after
-- first login (see api/auth.js action=platform-login, then use SQL to
-- update password_hash, or ask for a fresh hash any time).
insert into platform_admins (name, username, password_hash)
values ('Owner', 'admin', '83cad4ea8acf199dfdd66246e89480ab:8fcfb999d451768b54c79fc689682331c024744761817d69640d4c82efa262d32ba4bd0543bcbd86ee58ca40b6a61e0e3a7b5dfb07cfc6a3ec7eec529ed653ec')
