...
-- V58 — single-row settings table holding the owner's own business name,
-- used on every printed document (challan, report, POS slip, due notice)
-- instead of a hardcoded string. Distinct from the "AXIION DMS" app
-- branding, which is fixed in the UI chrome and not stored here.
